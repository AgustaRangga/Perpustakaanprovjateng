...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-gradient" id="topNavBar">
        <div class="container">
            ...
            <b class="text-light">Jadwal Reservasi Kunjungan</b>
            </a>
                ...
                <div class="cardt rounded-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <form action="save_schedule.php" method="post" id="schedule-form">
                                ...
                                <div class="form-group mb-2">
                                    <label for="description" class="control-label">Keperluan</label>
                                    <textarea rows="3" class="form-control form-control-sm rounded-0" name="description" id="description" required></textarea>
                                </div>
                                <div class="form-group mb-2">
                                    <label for="start_datetime" class="control-label">Jam Mulai</label>
                                    <input type="datetime-local" class="form-control form-control-sm rounded-0" name="start_datetime" id="start_datetime" required>
                                </div>
                                <div class="form-group mb-2">
                                    <label for="end_datetime" class="control-label">Jam Selesai</label>
                    ...
                    <div class="card-footer">
                        <div class="text-center">
                            ...
                            <a href="http://localhost/crudbooking/user/" class="btn btn-primary btn-sm rounded-0" role="button">Keluar</a>
                            <!-- <button class="btn btn-default border btn-sm rounded-0" onclick="goBack()">Kembali</button> -->
                ...
                <div class="modal-body rounded-0">
                    <div class="container-fluid">
                        <dl>
                            ...
                            <dt class="text-muted">Keperluan</dt>
