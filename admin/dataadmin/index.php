...
?>
    ...
    <a href="../admin/dataadmin/create.php" class="btn btn-primary" role="button">Tambah Data</a>
    <button class="button1"><a href="http://localhost/crudbooking/admin">Kembali</a> </button> 
